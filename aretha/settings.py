# -*- encoding: utf-8 -*-
# Django settings for aretha project.
...
SECRET_KEY = 'nms0)*^+k%8hz0z0&$$xfe4u$d5ld!kj6)q(d%*=^c+kmq2qu2'
...
try:
    from local_settings import *  # to allow local settings
except ImportError:
    pass